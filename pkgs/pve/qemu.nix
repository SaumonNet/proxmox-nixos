  ...
  (qemu.overrideAttrs (old: {
    ...
    patches =
      ...
      old.patches ++ [
        ...
        "${patchesDir}/extra/0004-migration-block-dirty-bitmap-fix-loading-bitmap-when.patch"
        ...
        "${patchesDir}/pve/0014-PVE-qapi-modify-query-machines.patch"
        "${patchesDir}/pve/0015-PVE-qapi-modify-spice-query.patch"
        ...
        "${patchesDir}/pve/0020-PVE-Add-dummy-id-command-line-parameter.patch"
        ...
        "${patchesDir}/pve/0025-PVE-Allow-version-code-in-machine-type.patch"
